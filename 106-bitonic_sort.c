...
/**
 * merge_bitonic_sort - Merge two consecutive bitonic arrays.
 * @array: Array to sort.
 * @size: Array's size.
 * @dir: Sorting direction, 1 is ascending, 0 is descending.
 * @osize: Original array's size.
 * @print: Flag to print result after merging, if is set to 1 the result
 *         is printed, if it's set to zero, the result is not printed.
 */
